...
export default function Store(props) {
    ...
    if(props.populationStatus == "Closed") {
        ...
        return (
            ...
            <Box style={styles.closed}>
                <VStack space={3} flex={0.85} justifyContent="left" >
                    <Text style={styles.toptextClosed}>
                        {props.title}
                    </Text>
                    <Text style={styles.bottomtextClosed}>
                        {props.status}
                    </Text>
        ...
        return (
            ...
            <Box style={styles.moderate}>
                <VStack space={3} flex={0.85} justifyContent="left" >
                    <Text style={styles.toptextModerate}>
                        {props.title}
                    </Text>
                    <Text style={styles.bottomtextModerate}>
                        {props.status}
                    </Text>
                    <Button variant="outline" width={279} style={{ marginTop: 170 }} onPress={() => navigation.navigate(props.nextLocation)} title="Go to other"/>
                </VStack>
    ...
    }else if(props.populationStatus == "Crowded") {

        return (
      
            <Box style={styles.crowded}>
                <VStack space={3} flex={0.85} justifyContent="left" >
                    <Text style={styles.toptextCrowded}>
                        {props.title}
                    </Text>
                    <Text style={styles.bottomtextCrowded}>
                        {props.status}
                    </Text>
                    <Button variant="outline" width={279} style={{ marginTop: 170 }} onPress={() => navigation.navigate(props.nextLocation)} title="Go to other"/>
                </VStack>
        ...
        return (
            ...
            <Box style={styles.empty}>
                <VStack space={3} flex={0.85} justifyContent="left" >
                    <Text style={styles.toptextEmpty}>
                        {props.title}
                    </Text>
                    <Text style={styles.bottomtextEmpty}>
                        {props.status}
                    </Text>
                    <Button variant="outline" width={279} style={{ marginTop: 170 }} onPress={() => navigation.navigate(props.nextLocation)} title="Go to other"/>
                </VStack>
